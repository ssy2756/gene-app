...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    sampleVitamins: Array.isArray(data.vitamins_and_minerals) ? data.vitamins_and_minerals : data.vitamins_and_minerals,
    sampleFitness: (data.fitness_and_nutrigenomics as Record<string, unknown> | undefined) ?? null,
  });
}
