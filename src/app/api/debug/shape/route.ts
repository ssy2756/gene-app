...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    sampleVitamins: data.vitamins_and_minerals,
    sampleFitness: data.fitness_and_nutrigenomics,
    sampleDrugs: pgx && Array.isArray(pgx.drug_recommendations) ? pgx.drug_recommendations.slice(0, 5) : null,
  });
}
